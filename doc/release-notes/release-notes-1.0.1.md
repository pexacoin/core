Pexa Core version *1.1.0* is now available!!
==============

  <https://github.com/pexacoin/core/releases/tag/v1.1.0>
...
If you are upgrading to 1.1.0 from a version before 2.1.0 the chainstate database for this release is 
...
Note: There are no consensus-rule changes between versions 2.1.0 and 1.1.0 - running versions in this range
...
Notable changes
==============
*This list includes changes from all releases between 2.1.0 and 1.1.0*
...
Changelog available here: <https://github.com/pexacoin/core/commits/release_1.1.0>
